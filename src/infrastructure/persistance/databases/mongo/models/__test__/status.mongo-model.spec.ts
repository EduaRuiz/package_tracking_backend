import { StatusMongoModel } from '..';

describe('StatusMongoModel', () => {
  let _id = '123456789';
  let name = 'name';
  ...
  it('should be defined', () => {
    // Act
    const entity = new StatusMongoModel(name, description);
  ...
  it('should defined all properties with values', () => {
    // Act
    const entity = new StatusMongoModel(name, description, _id);
